...
namespace alex290\yii2images\behaviors;
...
class SimpleImage
{
    ...
    protected $image, $filename, $original_info, $width, $height, $imagestring, $mimetype, $exif;
    ...
    function resize($width, $height)
    {
        ...
        // Resize
        imagecopyresampled($new, $this->image, 0, 0, 0, 0, (int)$width, (int)$height, (int)$this->width, (int)$this->height);
