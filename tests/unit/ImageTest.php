...
use alex290\yii2images\behaviors\ImageBehave;
...
class ImageTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $module = Yii::$app->getModule('alex290Store');
    ...
    public function testGetUrl()
    {
        ...
        $baseUrl = '/app/web/index-test.php/alex290Store/images/image-by-item-and-alias?item=ActiveRecordImage1&dirtyAlias=';
